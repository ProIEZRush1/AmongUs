...
public class Cameras extends ItemBuilder {
    ...
    public ItemStack build() {
        String name = items.get(null, "Impostor.Cameras.Name");
        String material = items.get(null, "Impostor.Cameras.Material");
        List<String> lore = items.getList("Impostor.Cameras.Lore");
