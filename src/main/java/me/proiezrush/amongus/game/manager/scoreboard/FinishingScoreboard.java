...
public class FinishingScoreboard implements Scoreboard {

    private final Settings config;
    private final Arena arena;
    public FinishingScoreboard(AmongUs plugin, Arena arena) {
    ...
    public BPlayerBoard scoreboard(Player player) {
        ...
        if (scoreboard == null) scoreboard = Netherboard.instance().createBoard(player, config.get(player, "Scoreboards.Finishing.Title"));

        List<String> lines = config.getList("Scoreboards.Finishing.Lines");
