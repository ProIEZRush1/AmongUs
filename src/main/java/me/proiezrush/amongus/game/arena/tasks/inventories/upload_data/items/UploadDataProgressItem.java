package me.proiezrush.amongus.game.arena.tasks.inventories.upload_data.items;
...
public class UploadDataProgressItem extends Icon {
    ...
    public UploadDataProgressItem(AmongUs plugin, ASCrewmate asCrewmate) {
        super();
    ...
    public ItemStack build() {
        ...
        String name = items.get(player, "Tasks.UPLOAD_DATA.Progress.Name").replace("%progress%", progress + "%");
        String material = items.get(player, "Tasks.UPLOAD_DATA.Progress.Material");
        List<String> lore = items.getList("Tasks.UPLOAD_DATA.Progress.Lore");
